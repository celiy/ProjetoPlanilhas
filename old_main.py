...
#Esta função utiliza a biblioteca panda para mostrar a planilha no terminal#
def mostrarplanilha():
...
#Esta função retorna True se a planilha informada pelo usuario existe e False se contrário#
...
#Edita um elemento especifico da planilha#
def editarelemento():
...
#Insere linhas novas a planilha#
def editararquivo():
    dados = []
...
#Esta função cria uma planilha nova com colunas informadas pelo usuário#
def arquivo(info_colunas):
...
#Esta função se (op) for True, cria uma planilha nova, se False, adiciona novas colunas a planilha existente#
def criararquivo():
...
###########################################
#-Começo do programa-#-Começo do programa-#
###########################################
