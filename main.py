try:
    ...
    print(error)
    print("Houve um erro na hora de usar a dependências. Por favor, os instale com o comando a seguir no seu CMD/Terminal: \n pip install -r requirements.txt")
    input()
else:
    ...
    def main():
        ...
        print("Insira o nome do arquivo da planilha: (Digite 0 para sair)")
